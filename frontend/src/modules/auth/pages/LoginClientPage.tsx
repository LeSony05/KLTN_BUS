  ...
  return (
    <div className="min-h-screen bg-white flex font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-[#143D30] overflow-hidden">
        ...
        <div 
          className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80')] bg-cover bg-center opacity-30 mix-blend-overlay"
        />
